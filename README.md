...
12.[__Pet-project__: Анализ CPA. Cнижение и стабилизация до целевых значений.](https://github.com/Utyugova/Y_Practicum/blob/main/y_direct/y_direct.ipynb)|Анализ CPA. Cнижение и стабилизация до целевых значений.|Python, Pandas, Matplotlib, Seaborn, Plotly, продуктовые метрики|
