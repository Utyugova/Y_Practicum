...
11.[Pet-project:Анализ базы данных фильмов TMDB](https://github.com/Utyugova/Y_Practicum/blob/main/TMDB/Orig_Movies%20(1).ipynb)|Изучение и анализ популярности и характеристик фильмов. Изучение тенденций в жанрах фильмов с течением времени, выявление закономерностей.|Python, Pandas, Matplotlib, Seaborn, Plotly, событийная аналитика.|
